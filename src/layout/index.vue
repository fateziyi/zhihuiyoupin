    ...
    <div class="layout_slider" :class="{ fold: LayoutsettingStore.fold ? true : false }">
      ...
      <el-scrollbar class="scrollbar" ref="scrollbarRef" always>
        ...
        <el-menu :collapse="LayoutsettingStore.fold ? true : false" :default-active="$route.path"
          background-color="#f8f8f8" text-color="#515767" active-text-color="#409eff" :collapse-transition="true">
          <!-- 根据路由动态生成菜单 -->
...
/* 全局样式：当菜单折叠时隐藏子菜单的箭头 */
:global(.el-menu--collapse .el-sub-menu > .el-sub-menu__title .el-sub-menu__icon-arrow) {
  display: none;
}
