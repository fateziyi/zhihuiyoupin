    ...
    <el-card>
      <el-form :inline="true">
        <el-form-item label="一级分类">
          <el-select :disabled="scene == 0 ? false : true" style="width: 220px;" v-model="categoryStore.c1Id"
            @change="handler">
        ...
        <el-form-item label="二级分类">
          <el-select :disabled="scene == 0 ? false : true" style="width: 220px;" v-model="categoryStore.c2Id"
            @change="handler1">
        ...
        <el-form-item label="三级分类">
          <el-select :disabled="scene == 0 ? false : true" style="width: 220px;" v-model="categoryStore.c3Id">
